...
import psycopg2
from apscheduler.schedulers.blocking import As
...
def get_from_minio_task():
    ...
    try:
        ...
        # Используйте ThreadPoolExecutor для асинхронного выполнения задач
        with concurrent.futures.ThreadPoolExecutor() as executor:
            futures = []
            for image_ref_path in images_path:
                future = executor.submit(get_object_from_minio, image_ref_path, images_state)
